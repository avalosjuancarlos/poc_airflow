        ...
        'chart': {
            'result': [{
                'meta': {
                    ...
                    'regularMarketPrice': sample_market_data['regular_market_price'],
                    'regularMarketTime': sample_market_data['regular_market_time'],
                    'fiftyTwoWeekHigh': sample_market_data['metadata']['fifty_two_week_high'],
                    'fiftyTwoWeekLow': sample_market_data['metadata']['fifty_two_week_low'],
