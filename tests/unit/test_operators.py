...
class TestFetchMarketDataOperator:
    ...
    def test_fetch_market_data_success(self, mock_client_class, mock_context, sample_market_data):
        ...
        mock_context['task_instance'].xcom_push.assert_called_once_with(
            key='market_data',
            value=sample_market_data
        )
    
    @patch('market_data.operators.market_data_operators.YahooFinanceClient')
    def test_fetch_market_data_calls_client_with_config(self, mock_client_class, mock_context):
...
class TestProcessMarketDataOperator:
    ...
    def test_process_market_data_logs_correctly(self, mock_context, sample_market_data, caplog):
